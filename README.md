...
[clusters at Zillow Group, available under the Apache License 2.0 license.
[Both Kong Community and Enterprise Edition are supported.
...
Example main.tf:
    ...
    module "kong" {
      source = "github.com/zillowgroup/kong-terraform?ref=v3.0"
